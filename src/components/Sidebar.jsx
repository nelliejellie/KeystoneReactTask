  ...
  return (
    <div className='w-[20%] md:w-[90%] h-[90vh] md:h-[45vh]'>
        <div className='space-y-5 pl-5'>
            <h1 className='text-[#12477E] font-bold text-[50px] text-left'>RETRO</h1>
            <div className='flex flex-col justify-start items-start'>
                <div className='dashboard flex flex-row w-[160px] space-x-2 items-center px-3 py-1 hover:bg-[#EDEFFA] hover:rounded-tr-md hover:rounded-br-md hover:rounded-bl-md '>
                    <AiOutlineLineChart className="text-[#AEB7BE] hover:text-[#3B78DE]"/>
